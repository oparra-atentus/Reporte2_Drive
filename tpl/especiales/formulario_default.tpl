...
<input type="hidden" name="multi_obj"   value="{__multi_obj}" />
<input type="hidden" name="contraloria"   value="{__contraloria}" />
<input type="hidden" name="pdf_especial"   value="{__pdf_especial}" />
<input type="hidden" name="img_especial" value="{__img_especial}" />
<input type="hidden" name="comparativo" value="{__comparativo}" />
<input type="hidden" name="mostrar_grafico" value="{__mostrar_grafico}" />
<input type="hidden" name="header_atentus" value="{__header_atentus}" />
<input type="hidden" name="mostrar_contacto" value="{__mostrar_contacto}" />
<input type="hidden" name="item_bloque" value="{__item_bloque}" />
<input type="hidden" name="especial_objetivo_id" value="{__objetivo_id_especial}" />
