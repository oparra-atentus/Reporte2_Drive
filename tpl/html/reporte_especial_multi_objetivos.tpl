...
<head>
	...
	<script type="text/javascript" src="tools/highcharts/highcharts-3d.js"></script>
	...
	<div id="cargando">
		...
		<form id="form_principal" name="form_principal" method="post" action="index.php">
			<div id="cargapagina" style="visibility:hidden;">
				...
				<tr>
					<td height="35" id="objetivo" style="padding: 4px 4px 4px 20px; background-color:#b7b7b7;">
						<span id="objetivo_nombre" class="txtBlanco15b" style=" text-shadow: black 0.1em 0.1em 0.2em">{__nombre_objetivo}</span>
					</td>
					<tr id ="espacio" style="height: 4px">
						<td id="espacio" style="background-color: #f47001;"></td>
					</tr>
				</tr>
				<!-- BEGIN LISTA_ITEMS -->
				<tr>
