	...
	$(document).ready(function() {
		var chart = AmCharts.makeChart( "chartdiv_{__id_chart}", {
				"type": "pie",
			  	...
			  	"dataProvider": [ {
			    	"tipo": "Llamadas contestadas",
			    	"value": {__contestadas},
			     	"color": "#54a51c"
		  	}, {
			    	"tipo": "Llamadas no contestadas",
		...
		$(".export").on('click', function(event) {
			var args = [$('#dvData>table'), '{__nombre_archivo_answer}.csv'];
			exportTableToCSV.apply(this, args);
		});

		$(".export2").on('click', function(event) {
			var args = [$('#dvData2>table'), '{__nombre_archivo_no_answer}.csv'];
			exportTableToCSV.apply(this, args);
		});

		$(".export3").on('click', function(event) {
			var args = [$('#dvData3>table'), '{__nombre_archivo_other}.csv'];
			exportTableToCSV.apply(this, args);
		});
