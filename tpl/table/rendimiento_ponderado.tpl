<!-- BEGIN LISTA_PASOS_TITULO -->
 ...
 <table width="100%">
 	...
 	<tr>
 		<td height="100%" colspan="100%" style="background-color: #626262; border: solid 1px #626262;"></td>
 	</tr>
 	<tr>
 		...
 		<td class="txtBlanco12b celdanegra40" align="center" width="15%">Mínimo</td>
 		<td class="txtBlanco12b celdanegra40" align="center" width="15%">Máximo</td>
 		<td class="txtBlanco12b celdanegra40" align="center" width="15%">Promedio</td>
 	</tr>
 	<!-- BEGIN LISTA_ITEMS -->
 	<tr>
