...
<style>
	...
	.tabla-datos .resumen{background-color: #7A8DBD; text-align: left; font-size:12px; font-weight: bold;}
...
<table width="100%" class="tabla-datos">
			...
			<table style="display: {__display_botones};">
				<tr>
					<td height="30" style="border: solid 2px #ffffff;" class="textnegro10">
						<span id="elementos_mostrados" class="textnegro10b">1-6</span> de <span id="elementos_total" class="textnegro10b">&nbsp;</span> Pasos&nbsp;&nbsp;
					</td>
	...
	<tr>
		<td valign="top">
			<table width="100%">
				<tr>
					<td height="26" class="cabecera textblanco12b" colspan="2">Objetivos</td>
					<!--<td height="26" class="resumen textblanco12b">Total</td>-->
				</tr>
				<tr style="background-color:#E9E9E9;">
					<td height="26" style="padding: 2px; background-color: #f47001;" class="textblanco12" >Global</td>
					<td height="26" style="padding: 2px; border-right: solid 2px #ffffff; background-color: #f58b32;" class="textblanco9" >&nbsp;</td>
					<!--<td height="26" class="cuerpo textblanco12">{__tiempo_respuesta_sumatoria_global}</td>-->
				</tr>
				<!-- BEGIN LISTA_NODOS -->
				<tr style="background-color:#{__nodo_color};">
					<td height="26" align="" style="padding: 2px; background-color: #f47001;" class="textblanco12" id="nodo_{__nodo_id}">
						<div class="contenedor" style="width: 100px;">{__nodo_nombre}</div>
						<div dojoType="dijit.Tooltip" connectId="nodo_{__nodo_id}, ubicacion_nodo_{__nodo_id}" position="below">
							<div class="textnegro12">{__nodo_nombre}</div>
							<div class="textnegro9">{__nodo_descripcion}</div>
						</div>
					</td>
					<td height="20" align="" style="padding: 2px; border-right: solid 2px #ffffff; background-color: #f58b32;" class="textblanco9" id="ubicacion_nodo_{__nodo_id}">
						<div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 80px;">{__nodo_descripcion}</div>
					</td>
					<!--<td height="26" class="cuerpo textblanco12" id="" style="">
						<div style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 80px;">{__tiempo_respuesta_sumatoria}</div>
					</td>-->
				</tr>
				<!-- END LISTA_NODOS -->
			</table>
		...
		<td valign="top" style="width: {__ancho_tabla};">
			<div id="elementos_scroll" style="width: {__ancho_tabla}; overflow: hidden;">
				<table>
					<tr>
						<td height="26" align="center" class="resumen textblanco12b" id="paso_consolidado">
							<div name="elemento_pagina" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 80px;">Consolidado</div>
							<div dojoType="dijit.Tooltip" connectId="paso_consolidado, ubicacion_consolidado" position="below">
								<div class="textnegro12">Consolidado</div>
							</div>
						</td>
						<!-- BEGIN LISTA_PASOS -->
						<td height="26" align="center" class="resumen textblanco12b" id="paso_{__paso_id}">
							<div name="elemento_pagina" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; width: 80px;">{__paso_nombre}</div>
							<div dojoType="dijit.Tooltip" connectId="paso_{__paso_id}, ubicacion_{__paso_id}" position="below">
				 	...
				 	<tr style="background-color:#E9E9E9;">
						...
						<td height="26" class="cuerpo textblanco12">
					...
					<tr style="background-color:#{__nodo_color};">
						<td height="26" class="cuerpo textblanco12">{__tiempo_respuesta_sumatoria}</td>
