<tr>
	...
	<table width="100%">
		...
		<tr>
			...
			<td class="txtNegro14bEspecialBold categoria" width="12%" align="center">{__acumulado_categoria}</td>
		</tr>
	...
	<div style="{__page_break}">
		<table width="100%">
			...
			<tr style="border-style: outset; border-color: #fff;">
				...
				<td class="txtNegro14bEspecialBoldFuncionalidad {__class_iteracion}" width="15%" align="center">{__acumulado_funcionalidad}</td>
			</tr>
			<!-- BEGIN BLOQUE_PASO -->
			<tr>
					...
					<div style="{__page_break_paso}">
						<table width="100%" align="center">
							<tr>
								...
								<td class="txtNegro12bEspecialPaso" style="border-bottom: solid 1px #fff; background: #{__class_iteracion_paso}; color: {__color_text}; padding-left: 25px;" width="15%" align="center">{__valor_paso}</td>
							</tr>
						</table>
					</div>
				</td>
