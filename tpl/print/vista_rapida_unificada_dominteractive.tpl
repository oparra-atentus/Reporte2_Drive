	...
	<td>
		<table width="100%">
			...
			<tr>
				<td align="center">
					<div id="formbutton">
						<input type="button" value="Generar Reporte" class="boton_accion" onclick="actualizaPopup('{__objetivo_especial}', '{__horario_id}', '{__usuario_id}', '{__clave_md5}');"/>
					</div>
	...
	<td colspan="2" id="td_vru">
		<table width="100%">
			<tr>
				...
				<td align="center"style="border: solid 1px #fff;" class="txtClaro10bEspecial celdaTituloNaranjo">INTERACCIÓN USUARIO [segs]</td>
			</tr>
			<!-- BEGIN BLOQUE_CATEGORIAS -->
			<tr>
				<td class="txtNegro14bEspecialBold categoria" width="40%" >{__nombre_categoria}</td>
				<td class="txtNegro14bEspecialBold categoria tooltip" width="15%" align="center">{__uptime_real_total} %
				...
				<td class="txtNegro14bEspecialBold categoria tooltip" width="15%" align="center">{__downtime_real_total} %
				...
				<td class="txtNegro14bEspecialBold categoria" width="15%" align="center" id="tr_c_{__id_cat}">{__tiempo_respuesta_total}</td>
				<td class="txtNegro14bEspecialBold categoria" width="15%" align="center" id="c_{__id_cat}"></td>
			</tr>
				...
				<table width="100%" id="table_cat">
					<tr id="tr_cat">
						<div>
							...
							<td height="25px" style="border: solid 1px #cccccc;" align="center" class="txtNegro10bEspecial">INTERACCIÓN USUARIO [segs]</td>
						</div>
					</tr>
					...
					<tr class="acordeon" style="border-style: outset; border-color: #fff; cursor: pointer;" id="tr_func">
						...
						<td class="txtNegro14bEspecialBoldFuncionalidad {__class_iteracion} tooltip" width="15%" align="center">{__uptime_real} %
							<table class="uptime" style="width: 90%;">
								<tr>
						...
						<td class="txtNegro14bEspecialBoldFuncionalidad {__class_iteracion} tooltip" width="15%" align="center">{__downtime_real} %
							<table class="downtime" style="width: 90%;">
								<tr>
						...
						<td class="txtNegro14bEspecialBoldFuncionalidad {__class_iteracion}" width="15%" align="center" id="tr_{__id_cat}_{__id_func}">{__tiempo_respuesta}</td>
						<td class="txtNegro14bEspecialBoldFuncionalidad {__class_iteracion}" width="15%" align="center" id="c_{__id_cat}_f_{__id_func}"></td>
					</tr>
									...
									<td>
										<table width="100%">
											<tr>
															...
															<td valign="center" style="text-align: center; ">
																<table width="100%">
																	...
																	<tr>
																		...
																		<td style="text-align: center; padding-top: 6px; font-weight: bold; width15; display: {__muestra_descarga};" valign="center">
												...
												<td class="txtNegro12bEspecialPaso tooltip" style="background: #{__class_iteracion_paso}; color: {__color_text}; padding-left: 25px" width="15%" align="center">{__uptime_real_paso} %
													<table class="uptime" style="width: 90%;">
														<tr>
												...
												<td class="txtNegro12bEspecialPaso tooltip" style="background: #{__class_iteracion_paso}; color: {__color_text}; padding-left: 25px" width="15%" align="center">{__downtime_real_paso} %
													<table class="downtime" style="width: 90%;">
														<tr>
												...
												<td class="txtNegro12bEspecialPaso tooltip" style="background: #{__class_iteracion_paso}; color: {__color_text}; padding-left: 25px" width="15%" align="center" id="tr_{__id_cat}_{__id_func}_{__obj_id}_{__paso_orden}">{__tiempo_respuesta_paso}</td>
												<td class="txtNegro12bEspecialPaso tooltip" style="background: #{__class_iteracion_paso}; color: {__color_text}; padding-left: 25px" width="15%" align="center" id="c_{__id_cat}_f_{__id_func}_o_{__obj_id}_p_{__paso_orden}"></td>
											</tr>
										</table>
									</td>
								</tr>
...
<script>
	...
	$(document).ready(function(){
		...
		$.ajax({
	        type: 'POST',
	        url: 'utils/getPerformancePaso.php',
	        data: {'function': 'performancePaso', 'objetivo_id': '{__objetivo_especial}', 'fecha_inicio': '{__fecha_inicio_api}', 'fecha_final': '{__fecha_termino_api}', 'usuario': '{__usuario_id}', 'horario': '{__horario_id}', 'clave_md5': '{__clave_md5}', 'listJson': '{__json_performance}'},
	        success: function(data) {
	        	json = JSON.parse(data)
				$.each(json["categoria"], function (indexC, categoria) {
					var catPerf = document.getElementById('c_'+categoria.categoria_index)
					var catTr = document.getElementById('tr_c_'+categoria.categoria_index)

					if (categoria.acumulado_categoria == 0 || categoria.acumulado_categoria == "sin informacion") {
						valorCat = catTr.innerHTML
					}else{
						valorCat = categoria.acumulado_categoria
					}
					var textCat = document.createTextNode(valorCat.toFixed(3))
					catPerf.appendChild(textCat)

					$.each(categoria["funcionalidad"], function (indexF, funcionalidad) {
						var funcTr = document.getElementById('tr_'+categoria.categoria_index+'_'+funcionalidad.index_funcionalidad)
						var funcPerf = document.getElementById('c_'+categoria.categoria_index+'_f_'+funcionalidad.index_funcionalidad)
						if (funcionalidad.acumulado_funcionalidad == 0 || funcionalidad.acumulado_funcionalidad == "sin informacion") {
							valorFunc = funcTr.innerHTML
						}else{
							valorFunc = funcionalidad.acumulado_funcionalidad
						}

						var textFunc = document.createTextNode(valorFunc.toFixed(3));
						funcPerf.appendChild(textFunc)

						$.each(funcionalidad["pasos"], function (indexP, pasos) {
							var pasoTr = document.getElementById('tr_'+categoria.categoria_index+'_'+funcionalidad.index_funcionalidad+'_'+pasos.objetivo+'_'+pasos.paso)
							var pasoPerf = document.getElementById('c_'+categoria.categoria_index+'_f_'+funcionalidad.index_funcionalidad+'_o_'+pasos.objetivo+'_p_'+pasos.paso)
							if (pasos.valor == "sin informacion" || pasos.valor == 0) {
								valorPaso = pasoTr.innerHTML
							}else{
								valorPaso = pasos.valor
							}
							var textPaso = document.createTextNode(valorPaso.toFixed(3));
							pasoPerf.appendChild(textPaso)
						})
					})
				})
			}
	...
	function actualizaPopup(objetivo_especial, horario_id, usuario_id, token){
		...
		setTimeout(function(){
			$.ajax({
				...
				type: 'POST',
				url: '../call_ajax.php',
				data: {'nameFunction':'vruAjaxPerf', 'objetivo_especial': objetivo_especial, 'horario_id': horario_id, 'usuario_id': usuario_id, 'fecha_inicio': fecha_inicio, 'fecha_termino': fecha_termino},
				success: function(data) {
					...
					td_vru = '<td colspan="2" id="td_vru">'+
											'<table width="100%">'+
												'<tr>'+
													...
													'<td align="center"style="border: solid 1px #fff;" class="txtClaro10bEspecial celdaTituloNaranjo">INTERACCIÓN USUARIO [segs]</td>'+
												'</tr>'
					$.each(json.vru, function (index, value) {
						$.each(value.categoria_global, function (i, categoria_global) {
							...
							td_vru += '<tr>'+
								...
								'<td class="txtNegro14bEspecialBold categoria tooltip" width="15%" align="center">'+categoria_global.disponibilidad[0].uptimecat+' %'+
									'<table class="uptime" style="width: 90%;">'+
										'<tr>'+
									...
									'</table>'+
								'</td>'+
								'<td class="txtNegro14bEspecialBold categoria tooltip" width="15%" align="center">'+categoria_global.disponibilidad[0].downtimecat+' %'+
									'<table class="downtime" style="width: 90%;">'+
										'<tr>'+
									...
									'</table>'+
								'</td>'+
								'<td class="txtNegro14bEspecialBold categoria" width="15%" align="center">'+categoria_global.disponibilidad[0].tiemporespuesta+'</td>'+
								'<td class="txtNegro14bEspecialBold categoria" width="15%" align="center">'+
								'<div class="formbutton2">'+
									'<div id="c_'+categoria_global.id_cat+'"></div>'+
								'</div>'+
						...
						td_vru +=	'<tr>'+
												'<td height="30px"></td>'+
											'</tr>'
						$.each(value.categoria, function (i, categoria) {
							...
							$.each(categoria.funcionalidad, function (j, funcionalidad) {
								...
								div_vru_c += '<tr class="acordeon" style="border-style: outset; border-color: #fff; cursor: pointer;">'+
															...
															'<td class="txtNegro14bEspecialBoldFuncionalidad '+funcionalidad.class_iteracion_func+' tooltip" width="15%" align="center">'+funcionalidad.uptime_real+' %'+
																'<table class="uptime" style="width: 90%;">'+
																	'<tr>'+
																...
																'</table>'+
															'</td>'+
															'<td class="txtNegro14bEspecialBoldFuncionalidad '+funcionalidad.class_iteracion_func+' tooltip" width="15%" align="center">'+funcionalidad.downtime_real+' %'+
																'<table class="downtime" style="width: 90%;">'+
																	'<tr>'+
																...
																'</table>'+
															'</td>'+
															'<td class="txtNegro14bEspecialBoldFuncionalidad '+funcionalidad.class_iteracion_func+'" width="15%" align="center" id="tr_'+categoria.id_cat+'_'+funcionalidad.id_func+'">'+funcionalidad.tiempo_respuesta+'</td>'+
															'<td class="txtNegro14bEspecialBoldFuncionalidad '+funcionalidad.class_iteracion_func+'" width="15%" align="center">'+
																'<div class="formbutton2">'+
																	'<div  id="c_'+categoria.id_cat+'_f_'+funcionalidad.id_func+'"></div>'+
																'</div>'+
																'<div class="lds-ring"><div></div><div></div><div></div><div></div></div>'+
															'</td>'+
														'</tr>'+
																	...
																	'<table width="100%">'+
																		'<tr>'+
																			'<td class="txtNegro12bEspecialPaso tooltip" width="40%" colspan="2"  style=" max-width: 250px; padding: 1px 6px 1px 25px; background: #'+pasos.class_iteracion_paso+'; color:  #'+pasos.color_text+';" onmouseover="document.getElementById(\''+pasos.hash+'\').style.display = \'inline\'" onmouseout="document.getElementById(\''+pasos.hash+'\').style.display = \'none\'">'+
																				...
																				'</table>'+
																			'</td>'+
																			'<td class="txtNegro12bEspecialPaso tooltip" style="background: #'+pasos.class_iteracion_paso+'; color: #'+pasos.color_text+'; padding-left: 25px" width="15%" align="center">'+pasos.uptime_real_paso+' %'+
																				'<table class="uptime" style="width: 90%;">'+
																					'<tr>'+
																				...
																				'</table>'+
																			'</td>'+
																			'<td class="txtNegro12bEspecialPaso tooltip" style="background: #'+pasos.class_iteracion_paso+'; color: #'+pasos.color_text+'; padding-left: 25px" width="15%" align="center">'+pasos.downtime_real_paso+' %'+
																				'<table class="downtime" style="width: 90%;">'+
																					'<tr>'+
																				...
																				'</table>'+
																			'</td>'+
																			'<td class="txtNegro12bEspecialPaso tooltip" style="background: #'+pasos.class_iteracion_paso+'; color: #'+pasos.color_text+'; padding-left: 25px" width="15%" align="center" id="tr_'+categoria.id_cat+'_'+funcionalidad.id_func+'_'+pasos.obj_id+'_'+pasos.paso_orden+'">'+pasos.tiempo_respuesta_paso+'</td>'+
																			'<td class="txtNegro12bEspecialPaso tooltip" style="background: #'+pasos.class_iteracion_paso+'; color: #'+pasos.color_text+'; padding-left: 25px" width="15%" align="center" id="c_'+categoria.id_cat+'_f_'+funcionalidad.id_func+'_o_'+pasos.obj_id+'_p_'+pasos.paso_orden+'"></td>'+
																		'</tr>'+
																	'</table>'+
																'</td>'+
															'</tr>'
			...
			callbackfunction(objetivo_especial, usuario_id, horario_id, token, json.dominteractive)
 		}, 1)
	}

	function callbackfunction(objetivo_especial, usuario_id, horario_id, token, dominteractive){
		dominteractiveString = JSON.stringify(dominteractive)
		var fecha_inicio = document.getElementById("fecha_inicio_periodico").value
		var fecha_termino = document.getElementById("fecha_termino_periodico").value

		fecha_inicio = fecha_inicio.replace("T", " ")
		fecha_termino = fecha_termino.replace("T", " ")

		var displayButton = document.getElementsByClassName("lds-ring")
		var displayForm = document.getElementsByClassName("formbutton2")
	    for(var i = 0; i < displayButton.length; i++){
	        displayButton[i].style.display = ""
	    }
	    for(var i = 0; i < displayForm.length; i++){
	        displayForm[i].style.display = "none"
	    }

		$.ajax({
	        type: 'POST',
	        url: 'utils/getPerformancePaso.php',
	        data: {'function': 'performancePaso', 'objetivo_id': objetivo_especial, 'fecha_inicio': fecha_inicio, 'fecha_final': fecha_termino, 'usuario': usuario_id, 'horario': horario_id, 'clave_md5': token, 'listJson': dominteractiveString.substring(1, dominteractiveString.length-1)},
	        success: function(data) {
	        	for(var i = 0; i < displayButton.length; i++){
			        displayButton[i].style.display = "none"
			    }
			    for(var i = 0; i < displayForm.length; i++){
			        displayForm[i].style.display = ""
			    }
