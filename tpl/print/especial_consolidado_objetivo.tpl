<table width="100%">
  ...
  <tr>
    ...
    <td align="right" value="{__uptime} " id="{__objetivo_id}" width="20%" style="{__style_obj} padding: 2px; background-color: #{__color_uptime};" class="textblanco12 bordeDerecho2">{__uptime} %</td>
