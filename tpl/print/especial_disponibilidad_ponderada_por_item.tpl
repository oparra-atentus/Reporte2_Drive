...
<table width="100%">
	...
	<tr>
		...
		<td class="txtGris12 celdaIteracion1 {__print_class}" align="right">{__evento_valor}</td>
		<!-- END BLOQUE_EVENTOS -->
	</tr>
	<!-- END LISTA_ITEMS -->
	<tr>
	 	<td class="txtBlanco13b celdaTituloGris" style="border: solid 1px #ffffff;" align="center" colspan="3">Total Acumulado</td>
		<!-- BEGIN BLOQUE_EVENTOS_TOTAL -->
		<td class="txtBlanco12 celdaTituloGris" style="border: solid 1px #ffffff;" align="right">{__evento_total}</td>
